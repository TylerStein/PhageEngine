...
public:
	...
	static inline void printActiveAttributes(GLuint programID, std::string title = "Shader") {
		GLint count;
	...
	static inline void printActiveUniforms(GLuint programID, std::string title = "Shader") {
		GLint count;
