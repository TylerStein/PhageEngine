...
public:
	...
	*/
	void createNewObject(pModel* model, pScript* script, pSoundSystem* soundSystem, pCamera* camera, glm::vec3 & pos, glm::vec3 & rot, GLfloat amount, glm::vec3 & scaling, std::string objName, pSceneNode* parent);
