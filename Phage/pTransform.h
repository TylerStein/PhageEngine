...
public:
	...
	pTransform(glm::vec3 position, glm::quat rotation = glm::quat(1, glm::vec3(1)), glm::vec3 scale = glm::vec3(1)) {
	...
	pTransform(glm::vec3 position, glm::vec3 eulerRotation = glm::vec3(0), glm::vec3 scale = glm::vec3(1)) {
		setPosition(position);
