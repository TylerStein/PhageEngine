...
struct MaterialInfo {
	...
	MaterialInfo(
		glm::vec3 _diffuse = glm::vec3(1.0f), glm::vec3 _ambient = glm::vec3(0.1f), 
		glm::vec3 _specular = glm::vec3(0.1f), glm::vec3 _emission = glm::vec3(0.0f),GLfloat _shininess = 128.0f,
		pImage* _diffuseTexture = nullptr, pImage* _specularTexture = nullptr, pImage* _bumpTexture = nullptr,
